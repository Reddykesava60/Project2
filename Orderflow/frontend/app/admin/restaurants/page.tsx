...
type RestaurantStatus = "active" | "suspended" | "cancelled";
type RestaurantActionStatus = "active" | "suspended";
...
export default function AdminRestaurantsPage() {
  ...
  const [newStatus, setNewStatus] = useState<RestaurantActionStatus>("active");
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-warning">
              {restaurants.filter((r) => r.subscription_status === "cancelled").length}
            </div>
