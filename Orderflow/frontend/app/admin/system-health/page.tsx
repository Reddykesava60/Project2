  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge
        ...
        className={status === 'HEALTHY' ? 'bg-green-100 text-green-800 border-transparent' : undefined}
      >
        {status}
      </Badge>
    )
    ...
    <Card>
      ...
      <CardContent>
        <Badge
          ...
          className={status === 'UP' ? 'bg-green-100 text-green-800 border-transparent' : undefined}
        >
          {status}
        </Badge>
      </CardContent>
